...
- 🧵 **Assign filament from a phone** — Open `/spoolbuddy/assign`, scan a printer label and spool label, pick the AMS or external holder slot, and Bambuddy applies the existing inventory or Spoolman slot-assignment workflow.
